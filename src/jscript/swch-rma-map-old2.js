...
var RMAMap = function (
    ...
    searchBoxSelector, searchButtonSelector, searchCloseButtonSelector) { 
...
RMAMap.prototype.updateCaption = function () {  
    ...
    if (featureCount > 1) {
        var scalar = Math.pow(10, this.activeTheme.digitCount)/10;
        var total = 0;
...
RMAMap.prototype.updateTheme = function (themeNumber, themeName, themeData, method, classCount, reportingUnit, isFloat) {
